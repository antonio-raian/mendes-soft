...
const ModalDetailsEmployee: React.FC<ModalProps> = ({
  isOpen,
  setIsOpen,
  itemId,
}) => {
  ...
  const redirectToUpdate = useCallback(() => {
    history.push("/funcionarios/atualiza", { itemId });
  }, [itemId, history]);
  ...
  return (
    <>
      ...
      <ModalComponent
        ...
        closeOnOverlay={true}>
        <Container>
          <h3>Deseja remover o funcionário {"nome"}?</h3>
          <Buttons>
...
export default ModalDetailsEmployee;
